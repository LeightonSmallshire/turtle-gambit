...
-- MAXIMUM MINING AMOUNT PER TRIP PER TURTLE
mission_length = 150

-- EXTRA FUEL FOR TURTLES TO BRING ALONG, JUST IN CASE
fuel_padding = 30

-- FUEL PER ITEM
fuel_per_unit = 80

-- TIME AFTER LAST PING TO DECLARE TURTLE DISCONNECTED
turtle_timeout = 5

-- TIME AFTER LAST PING TO DECLARE POCKET DISCONNECTED
pocket_timeout = 5

-- TIME TO WAIT AFTER SENDING TASK WITH NO RESPONSE TO RESEND
task_timeout = 0.5
...
locations = {
    ...
    -- THE BLOCK TURTLES WILL COME UP TO FROM THE MINE
    --     one block higher by default.
    mine_exit = { x = c.x + 0, y = c.y + 1, z = c.z + 1 },

    -- THE BLOCK TURTLES GO TO IN ORDER TO ACCESS THE CHEST FOR ITEMS
    item_drop = { x = c.x + 2, y = c.y + 1, z = c.z + 1, orientation = 'east' },

    -- THE BLOCK TURTLES GO TO IN ORDER TO ACCESS THE CHEST FOR FUEL
